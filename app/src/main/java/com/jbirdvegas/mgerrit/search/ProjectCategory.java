...
public class ProjectCategory extends SearchCategory<ProjectSearch> {
    ...
    public View dialogLayout(Context context, LayoutInflater inflater) {
        ...
        AutoCompleteTextView textView = (AutoCompleteTextView) view.findViewById(R.id.autoCompleteProject);
        if (keyword != null) {
    ...
    public ProjectSearch onSave(Dialog dialog) {
        EditText text = (EditText) dialog.findViewById(R.id.autoCompleteProject);
