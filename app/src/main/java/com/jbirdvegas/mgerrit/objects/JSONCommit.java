...
public class JSONCommit {
    ...
    public JSONCommit(Context context, String changeid, int commitNumber, String project,
        ...
        mWebAddress = String.format("%s%d/", PrefsFragment.getCurrentGerrit(context), mCommitNumber);
    }
    ...
    public static JSONCommit getInstance(JSONObject object, Context context) {
        ...
        thisCommit.mServerTimeZone = PrefsFragment.getServerTimeZone(context);
        thisCommit.mLocalTimeZone = PrefsFragment.getLocalTimeZone(context);
