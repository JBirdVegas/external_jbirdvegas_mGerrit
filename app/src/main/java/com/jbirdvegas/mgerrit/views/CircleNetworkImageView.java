...
/**
 * The CircleImageView copied from de.hdodenhof.circleimageview so we can extend Volley's
 *  NetworkImageView.
 * Unused style parameters and functionality has been removed. In particular, modifying the border
 *  or fill color is not currently supported.
 */
