 ...
 *
 * @since 1.6
 * @version $Id: BeiderMorseApacheEncoder.java 1429868 2013-01-07 16:08:05Z ggregory $
 */
public class BeiderMorseApacheEncoder implements StringApacheEncoder {
    ...
    public Object encode(final Object source) throws EncoderException {
        if (!(source instanceof String)) {
            throw new EncoderException("BeiderMorseApacheEncoder encode parameter is not of type String");
        }
