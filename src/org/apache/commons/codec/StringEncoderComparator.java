...
/**
 * Compares Strings using a {@link StringApacheEncoder}. This comparator is used to sort Strings by an encoding scheme such as
...
public class StringEncoderComparator implements Comparator {
     ...
     */
    private final StringApacheEncoder stringEncoder;

    /**
     * Constructs a new instance.
     *
     * @deprecated Creating an instance without a {@link StringApacheEncoder} leads to a {@link NullPointerException}. Will be
     *             removed in 2.0.
     */
    @Deprecated
     ...
     *
     * @param stringEncoder
     *            the StringApacheEncoder used for comparisons.
     */
    public StringEncoderComparator(final StringApacheEncoder stringEncoder) {
        this.stringEncoder = stringEncoder;
    }

    /**
     * Compares two strings based not on the strings themselves, but on an encoding of the two strings using the
     * StringApacheEncoder this Comparator was created with.
     *
